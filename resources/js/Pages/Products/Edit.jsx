...
export default function Edit({ auth }) {
    const { errors, product, companies } = usePage().props;
    ...
    return (
        ...
        header={<a href={route('products.index')}>products/modifier</a>}
        >
            <Head title="Edit Product" />
            <div className="container my-5">
                <h1 className='text-dark fw-bold fs-1 mb-5 '>Edit Product</h1>
