...
export default function CreateWithDimenssion({ auth }) {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" className="form-control" value={data.typeCarburant} onChange={e => setData('typeCarburant', e.target.value)} />
                            {errors.typeCarburant && <div className="text-danger">{errors.typeCarburant}</div>}
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label">Capacité du Réservoir</label>
                            <input type="number" className="form-control" value={data.capaciteReservoir} onChange={e => setData('capaciteReservoir', e.target.value)} />
                            {errors.capaciteReservoir && <div className="text-danger">{errors.capaciteReservoir}</div>}
                        </div>
                    </div>

                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <label className="form-label">Puissance du Moteur</label>
                            <input type="number" className="form-control" value={data.puissanceMoteur} onChange={e => setData('puissanceMoteur', e.target.value)} />
                            {errors.puissanceMoteur && <div className="text-danger">{errors.puissanceMoteur}</div>}
                        </div>
                        <div className="col-md-6 mb-3">
                            <label className="form-label">Kilométrage</label>
                            <input type="number" className="form-control" value={data.kilometrage} onChange={e => setData('kilometrage', e.target.value)} />
                    ...
                    <div className="row">
                        <div className="col-md-10 mx-auto d-flex justify-content-between my-3">
                            <button type="submit" className="btn col-md-3 btn-outline-primary ">Enregistrer</button>
                            <button type="submit" className="btn col-md-3 btn-outline-info " value={"multi"} onClick={() => setSaveAndContinue(1)}>Enregistrer et continuer</button>
